...
class Admin extends CI_Controller
{
    ...
    function dashboard()
    {
        ...
        $page_data['page_title'] = get_phrase('Administrator_pagina_principala');
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('message', get_phrase('setari_actualizate'));
        ...
        $page_data['page_title'] = get_phrase('administreaza_limba');
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('setari_sistem');
    ...
    function sms_settings($param1 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('message', get_phrase('setati_actualizate'));
            redirect(site_url('admin/sms_settings'), 'refresh');
        }
        
        $page_data['page_name']  = 'sms_settings';
        $page_data['page_title'] = get_phrase('setari_sms');
        $this->load->view('backend/index', $page_data);
    }
    
    /*     * ****GESTIUNEA PROFILULUI DUMNEAVOASTRĂ ȘI SCHIMBAREA PAROLEI** */
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            if ($validation == 1) {
                ...
                $this->session->set_flashdata('message', get_phrase('informati_profil_actualizate_cu_succes'));
                redirect(site_url('admin/manage_profile'), 'refresh');
            } else {
                $this->session->set_flashdata('error_message', get_phrase('email_dublicat'));
                redirect(site_url('admin/manage_profile'), 'refresh');
            }
    ...
    function department($task = "", $department_id = "")
    {
        ...
        if ($task == "create") {
            ...
            $this->session->set_flashdata('message', get_phrase('infortmati_specializare_salvate_cu_succes'));
            redirect(site_url('admin/department'), 'refresh');
        }
        
        if ($task == "update") {
            $this->crud_model->update_department_info($department_id);
            $this->session->set_flashdata('message', get_phrase('infortmati_specializare_actualizate_cu_succes'));
            redirect(site_url('admin/department'), 'refresh');
        }
        ...
        $data['page_title']      = get_phrase('specializare');
    ...
    function department_facilities($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'add') {
            ...
            $this->session->set_flashdata('message', get_phrase('facilitati_salvate_cu_succes'));
            redirect(site_url('admin/department_facilities/' . $param2), 'refresh');
        }
        
        if ($param1 == 'edit') {
            $this->frontend_model->edit_department_facility($param2);
            $this->session->set_flashdata('message', get_phrase('facilitati_actualizate_cu_succes'));
            redirect(site_url('admin/department_facilities/' . $param3), 'refresh');
        }
        
        if ($param1 == 'delete') {
            $this->frontend_model->delete_department_facility($param2);
            $this->session->set_flashdata('message', get_phrase('facilitati_sterse_cu_succes'));
            redirect(site_url('admin/department_facilities/' . $param3), 'refresh');
        }
        ...
        $data['page_title']      = get_phrase('facilitatile_specializari') . ' | ' . $data['department_info']->name . ' ' . get_phrase('specializarea');
        $this->load->view('backend/index', $data);
    }
    ...
    function doctor($task = "", $doctor_id = "")
    {
        ...
        if ($task == "create") {
            ...
            if ($validation == 1) {
                ...
                $this->session->set_flashdata('message', get_phrase('informati_doctor_salvate_cu_succes'));
            } else {
                $this->session->set_flashdata('error_message', get_phrase('eamil_dublicat'));
            }
    ...
    function patient($task = "", $patient_id = "")
    {
        ...
        if ($task == "create") {
            ...
            $this->session->set_flashdata('message', get_phrase('inforamti_pacient_salvate_cu_succes'));
        ...
        $data['page_title']   = get_phrase('pacient');
        $this->load->view('backend/index', $data);
    }
    ...
    function nurse($task = "", $nurse_id = "")
    {
        ...
        if ($task == "create") {
            ...
            $this->session->set_flashdata('message', get_phrase('inforamti_asistenta_salvate_cu_succes'));
    ...
    function pharmacist($task = "", $pharmacist_id = "")
    {
        ...
        if ($task == "create") {
            ...
            $this->session->set_flashdata('message', get_phrase('inforamti_farmacist_salavate_cu_succes'));
        ...
        $data['page_title']      = get_phrase('farmacist');
        $this->load->view('backend/index', $data);
    }
    ...
    function laboratorist($task = "", $laboratorist_id = "")
    {
        ...
        if ($task == "create") {
            ...
            $this->session->set_flashdata('message', get_phrase('informati_laborant_salvate_cu_succes'));
        ...
        $data['page_title']        = get_phrase('laborant');
        $this->load->view('backend/index', $data);
    }
    ...
    function accountant($task = "", $accountant_id = "")
    {
        ...
        if ($task == "create") {
            ...
            $this->session->set_flashdata('message', get_phrase('informati_contabil_salvate_cu_succes'));
        ...
        $data['page_title']      = get_phrase('contabil');
        $this->load->view('backend/index', $data);
    }
    ...
    function receptionist($task = "", $receptionist_id = "")
    {
        ...
        if ($task == "create") {
            ...
            $this->session->set_flashdata('message', get_phrase('informati_receptionist_salvate_cu_succes'));
    ...
    function payment_history($task = "")
    {
        ...
        $data['page_title']   = get_phrase('istoria_platilor');
        $this->load->view('backend/index', $data);
    }
    ...
    function bed_allotment($task = "")
    {
        ...
        $data['page_title']         = get_phrase('alocarea_paturilor');
        $this->load->view('backend/index', $data);
    }
    ...
    function blood_donor($task = "")
    {
        ...
        $data['page_title']       = get_phrase('donatori_de_sange');
        $this->load->view('backend/index', $data);
    }
    ...
    function medicine($task = "")
    {
        ...
        $data['page_title']    = get_phrase('medicamente');
        $this->load->view('backend/index', $data);
    }
    ...
    function operation_report($task = "")
    {
        ...
        $data['page_title'] = get_phrase('raportul_de_funcționare');
        $this->load->view('backend/index', $data);
    }
    ...
    function birth_report($task = "")
    {
        ...
        $data['page_title'] = get_phrase('raport_nasteri');
        $this->load->view('backend/index', $data);
    }
    ...
    function death_report($task = "")
    {
        ...
        $data['page_title'] = get_phrase('raport_decedati');
        $this->load->view('backend/index', $data);
    }
    ...
    function notice($task = "", $notice_id = "")
    {
        ...
        if ($task == "create") {
            ...
            $this->session->set_flashdata('message', get_phrase('informația_despre_anunț_a_fost_salvată_cu_succes'));
            redirect(site_url('admin/notice'), 'refresh');
        }
        
        if ($task == "update") {
            $this->crud_model->update_notice_info($notice_id);
            $this->session->set_flashdata('message', get_phrase('informatile_actualizate_cu_succes'));
            redirect(site_url('admin/notice'), 'refresh');
        }
        ...
        $data['page_title']  = get_phrase('avizier');
        $this->load->view('backend/index', $data);
    }
    ...
    function payroll()
    {
        ...
        $page_data['page_title'] = get_phrase('creaza_salarisare');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function create_payroll()
    {
        ...
        $this->session->set_flashdata('message', get_phrase('data_creata_cu_succes'));
    ...
    function payroll_list($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'mark_paid') {
            ...
            $this->session->set_flashdata('message', get_phrase('data_actualizata_succes'));
            redirect(site_url('admin/payroll_list'), 'refresh');
        }
    ...
    function frontend($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = get_phrase('gestioneaza_website');
        $this->load->view('backend/index', $page_data);
    }
    
    // Actualizați frontend setări
    function frontend_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'slider') {
            ...
            $this->session->set_flashdata('message', get_phrase('schimbarile_salvate_cu_succes'));
        ...
        if ($param1 == 'service_new') {
            ...
            $this->session->set_flashdata('message', get_phrase('serviciul_salavat_cu_succes'));
            redirect(site_url('admin/frontend/service'), 'refresh');
        }
        
        if ($param1 == 'service_edit') {
            $this->frontend_model->update_service($param2);
            $this->session->set_flashdata('message', get_phrase('seriviciul_actualizat_cu_succes'));
            redirect(site_url('admin/frontend/service'), 'refresh');
        }
        
        if ($param1 == 'service_delete') {
            $this->frontend_model->delete_service($param2);
            $this->session->set_flashdata('message', get_phrase('servicul_sters_cu_succes'));
            redirect(site_url('admin/frontend/service'), 'refresh');
        }
        
        if ($param1 == 'blog_new') {
            $this->frontend_model->add_new_blog();
            $this->session->set_flashdata('message', get_phrase('postarea_salvat_succes'));
            redirect(site_url('admin/frontend/blog'), 'refresh');
        }
        
        if ($param1 == 'blog_edit') {
            $this->frontend_model->update_blog($param2);
            $this->session->set_flashdata('message', get_phrase('sachimbarile_salvate_cu_succes'));
            redirect(site_url('admin/frontend/blog'), 'refresh');
        }
        
        if ($param1 == 'blog_delete') {
            $this->frontend_model->delete_blog($param2);
            $this->session->set_flashdata('message', get_phrase('blog_sters'));
            redirect(site_url('admin/frontend/blog'), 'refresh');
        }
        
        if ($param1 == 'about_us') {
            $this->frontend_model->update_about_us();
            $this->session->set_flashdata('message', get_phrase('data_actualizata'));
            redirect(site_url('admin/frontend/about_us'), 'refresh');
        }
        
        if ($param1 == 'settings') {
            $this->frontend_model->update_frontend_settings();
            $this->session->set_flashdata('message', get_phrase('schimbare_salvata_cu_succes'));
    ...
    function contact_email($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('message', get_phrase('email_sters'));
            redirect(site_url('admin/contact_email'), 'refresh');
        }
        
        $page_data['page_name']      = 'contact_email';
        $page_data['page_title']     = get_phrase('contacte_email');
