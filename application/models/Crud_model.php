...
class Crud_model extends CI_Model {
    ...
    function update_doctor_info($doctor_id)
    {
        ...
        if ($validation == 1){
          ...
          move_uploaded_file($_FILES["image"]["tmp_name"], 'uploads/doctor_image/' . $doctor_id . '.jpg');
          $this->session->set_flashdata('message', get_phrase('actualizare_cu_succes'));
        }
        else{
    ...
    function update_laboratorist_info($laboratorist_id)
    {
        ...
        if ($validation == 1) {
          ...
          move_uploaded_file($_FILES["image"]["tmp_name"], 'uploads/laboratorist_image/' . $laboratorist_id . '.jpg');
          $this->session->set_flashdata('message', get_phrase('actalizare_cu_succes'));
        }
        else{
          $this->session->set_flashdata('error_message', get_phrase('email_dublicat'));
        }
    ...
    function curl_request($code = '') {
        ...
        //setarea antetului pentru rest api
