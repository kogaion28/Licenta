<div class="sidebar-menu">
    <header class="logo-env" >
        ...
        <!-- sigla de restrângere a logo-ului -->
    ...
    <div class="sidebar-user-info">
        ...
        <div class="sui-hover inline-links animate-in"><!-- You can remove "inline-links" class to make links appear vertically, class "animate-in" will make A elements animateable when click on user profile -->				
            <a href="<?php echo site_url('accountant/manage_profile');?>">
                ...
                <?php echo get_phrase('editeaza_profilul'); ?>
            </a>

            <a href="<?php echo site_url('accountant/manage_profile');?>">
                <i class="entypo-lock"></i>
                <?php echo get_phrase('schima_parola'); ?>
            </a>
    ...
    <ul id="main-menu" class="">
        ...
        <!--<li class="<?php if ($page_name == 'form') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?accountant/form">
                <i class="fa fa-desktop"></i>
                <span><?php echo get_phrase('forma'); ?></span>
            </a>
        </li>-->
        ...
        <li class="<?php if ($page_name == 'payroll_list') echo 'active'; ?> ">
            <a href="<?php echo site_url('accountant/payroll_list');?>">
                <span><i class="entypo-tag"></i> <?php echo get_phrase('salarizare'); ?></span>
            </a>
        </li>
