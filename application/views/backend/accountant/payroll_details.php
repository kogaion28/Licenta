    ...
    <div id="payroll_print">
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right">
                    <h4><?php echo get_phrase('salarizare_cod'); ?> : <?php echo $row['payroll_code']; ?></h4>
        ...
        <?php if($row['allowances'] == '') { ?>
            <div class="alert alert-info"><?php echo get_phrase('fără_alocații');?></div>
        <?php } else { ?>
        ...
        <br>
        <h3 style="text-align: center; margin-bottom: 0px;"><?php echo get_phrase('salariu rezumat'); ?></h3>
