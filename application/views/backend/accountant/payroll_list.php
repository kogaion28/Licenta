<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th><div><?php echo get_phrase('rezumat'); ?></div></th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div>
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('alocația_totală'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                ...
                <td>
                    ...
                    if($row['status'] == 1)
                        ...
                        echo '<div class="label label-danger">' . get_phrase('neplatiti').'</div>';
                    ?>
                </td>
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/payroll_details/'.$row['payroll_id']); ?>');">
                                    <i class="fa fa-eye"></i> &nbsp;
                                    <?php echo get_phrase('vizualizați_detaliile_salarizării'); ?>
                                </a>
                            </li>
                        </ul>
                    </div>
