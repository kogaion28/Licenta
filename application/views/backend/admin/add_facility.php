        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <?php echo get_phrase('adauga_facilitati');?> | <?php echo $department->name;?> <?php echo get_phrase('specializare');?>
                    </h4>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups"
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('departament'); ?></label>
