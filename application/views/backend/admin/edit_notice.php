            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('editeaza_anunț'); ?></h3>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal form-groups" role="form" method="post"
                        ...
                        <div class="form-group">
                            <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('descrere'); ?></label>
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('data_de_start'); ?></label>

                            <div class="col-sm-7">
                                <input type="text" name="start_timestamp" class="form-control datepicker" data-format="D, dd MM yyyy"
                                       placeholder="<?php echo get_phrase('data_de_start_evenimente');?>" value="<?php echo date("D, d M Y", $row['start_timestamp']); ?>" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('sfarsit_data'); ?></label>
