            ...
            <form action="<?php echo site_url('admin/frontend_settings/blog_edit/'.$blog->frontend_blog_id);?>" 
                ...
                <div class="form-group">
                    <label for="field-ta" class="col-sm-3 control-label">
                        <?php echo get_phrase('blog_postari'); ?>
                    </label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label">
                        <?php echo get_phrase('publica_pe_website');?>
                    </label>
                    <div class="col-sm-6">
                        <select name="published" class="selectboxit">
                            <option value="0"
                                <?php if ($blog->published == 0) echo 'selected';?>><?php echo get_phrase('nu');?></option>
                            <option value="1"
                                <?php if ($blog->published == 1) echo 'selected';?>><?php echo get_phrase('da');?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <button type="submit" class="btn btn-success">
                            <i class="fa fa-chech"></i> <?php echo get_phrase('actualizeaza');?>
                        </button>
                    </div>
                </div>
