        ...
        <form action="<?php echo site_url('admin/frontend_settings/settings');?>" 
            ...
            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">
                    <?php echo get_phrase('namele_spitalului');?>
                </label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">
                    <?php echo get_phrase('contate_de_ugente');?>
                </label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">
                    <?php echo get_phrase('orele_de_deschidere');?>
                </label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="monday_friday"
                        value="<?php echo $open[0]->monday_friday;?>">
                    <span class="description"><?php echo get_phrase('luni').' - '.get_phrase('vineri');?></span>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="saturday"
                        value="<?php echo $open[0]->saturday;?>">
                    <span class="description"><?php echo get_phrase('sâmbătă');?></span>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="sunday"
                        value="<?php echo $open[0]->sunday;?>">
                    <span class="description"><?php echo get_phrase('duminică');?></span>
                </div>
            </div>

            <?php 
                $social_links = $this->frontend_model->get_frontend_settings('linkuri_sociale');
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <span class="description"><?php echo get_phrase('facebook_pagina_link');?></span>
                    <br>
                    ...
                    <span class="description"><?php echo get_phrase('youtube_canal_link');?></span>
                </div>
            </div>

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">
                    <?php echo get_phrase('drepturi_text');?>
                </label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">
                   Recaptcha <?php echo get_phrase('setari');?>
                </label>
                <div class="col-sm-6">
