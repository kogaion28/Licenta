        ...
        <div class="tab-content" style="padding-top: 15px;">
            ...
            <div class="tab-pane <?php if(!isset($edit_profile))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
                    <thead>
                        <tr>
                            <th><?php echo get_phrase('limba');?></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/manage_language/edit_phrase/'.$field);?>"
                                     class="btn btn-info">
                                        <?php echo get_phrase('edit_fraza');?>
                                </a>
                                <a href="<?php echo site_url('admin/manage_language/delete_language/'.$field);?>"
                                    rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('sterge_limba');?>" class="btn btn-gray" onclick="return confirm('Sterge Limba?');">
                    ...
                    <?php echo form_open(site_url('admin/manage_language/add_phrase') , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('fraza');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="phrase" data-validate="required" data-message-required="<?php echo get_phrase('cerere_valuare');?>"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-success"><?php echo get_phrase('adauga_fraza');?></button>
                              </div>
                            </div>
                    <?php echo form_close();?>                
                </div>                
                    ...
                    <?php echo form_open(site_url('admin/manage_language/add_language'), array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="language" data-validate="required" data-message-required="<?php echo get_phrase('cere_valuare');?>"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-success"><?php echo get_phrase('adauga_limba');?></button>
                              </div>
                            </div>
                    <?php echo form_close();?> 
                </div>
	...
	function updatePhrase(phraseId) {
		...
		$.ajax({
			...
			success : function(response) {
				...
				toastr.success('<?php echo get_phrase('fraza_actualizata');?>');
			}
		});
	}
</script>