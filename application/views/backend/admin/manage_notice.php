<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_notice'); ?>');" 
    class="btn btn-primary pull-right">
        <i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('adauga_notificare'); ?>
</button>
...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('data_de_start'); ?></th>
            <th><?php echo get_phrase('sfarsit_data'); ?></th>
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        ...
                        <?php echo get_phrase('programare_eveniment'); ?>
                    </h4>
                </div>
            </div>
