    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select name="employee_id" class="form-control select2" required>
                    ...
                    <option value=""><?php echo get_phrase('selcteaza_un_angajat'); ?></option>
                    <?php
        ...
        <div class="col-md-3" style="margin-top: 27px;">
            <button type="submit" class="btn btn-info" style="width: 100%;">
                <?php echo get_phrase('genereaza_fluturaș'); ?></button>
        </div>
    ...
    <div class="row">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        <h4><?php echo get_phrase('alocație'); ?></h4>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="allowance_type[]"
                                    placeholder="<?php echo get_phrase('tipul'); ?>"/>
                            </div>

                            <div class="col-sm-5">
                                <input type="number" class="form-control" name="allowance_amount[]"
                                    placeholder="<?php echo get_phrase('suma'); ?>"
                    ...
                    <div class="form-group">
                        <div class="col-sm-5" style="text-align: right;">
                            <button type="button" class="btn btn-default btn-sm" onClick="add_allowance()">
                                ...
                                <?php echo get_phrase('adauga_alocatie');?>
                            </button>
                        </div>

                        <div class="col-sm-5">
                            <button type="button" class="btn btn-info btn-sm" onClick="calculate_total_allowance()">
                                <?php echo get_phrase('calculați_alocația_totală'); ?>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        <h4><?php echo get_phrase('deducere'); ?></h4>
                    </div>
                </div>
                <div class="panel-body ">
                    <span id="deduction">
                    ...
                    <span id="deduction_input">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" class="form-control" name="deduction_amount[]"
                                    placeholder="<?php echo get_phrase('suama'); ?>"
                                    id="deduction_amount" />
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-5" style="text-align: right;">
                            <button type="button" class="btn btn-default btn-sm" onClick="add_deduction()">
                                <i class="fa fa-plus"></i>&nbsp;
                                <?php echo get_phrase('adauga_deducere'); ?>
                            </button>
                        </div>

                        <div class="col-sm-5">
                            <button type="button" class="btn btn-info btn-sm" onClick="calculate_total_deduction()">
                                <?php echo get_phrase('calcleaza_deducerea_totala'); ?>
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        <h4><?php echo get_phrase('salariu_rezumat'); ?></h4>
                    </div>
                </div>
                ...
                <div class="panel-body ">
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('baza'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('alocația_totală'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('deducerea_totală'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('slariu_net'); ?></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select name="status" class="form-control selectboxit">
                                <option value="1"><?php echo get_phrase('platit'); ?></option>
                                <option value="0"><?php echo get_phrase('neplatit'); ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-success">
                                <i class="fa fa-check"></i> <?php echo get_phrase('creați_plăți'); ?>
                            </button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function get_employees(department_id)
    {
        if(department_id != '')
            ...
            jQuery('#employee_holder').html('<option value=""><?php echo get_phrase("selecteaza_o_specializare_prima_data"); ?></option>');
    }
