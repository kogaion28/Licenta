<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            <th><div>#</div></th>
            <th><div>ID</div></th>
            <th><div><?php echo get_phrase('angajat'); ?></div></th>
            <th><div><?php echo get_phrase('tip_cont'); ?></div></th>
            <th><div><?php echo get_phrase('total'); ?></div></th>
            <th><div><?php echo get_phrase('data'); ?></div></th>
            <th><div><?php echo get_phrase('status'); ?></div></th>
            <th><div><?php echo get_phrase('optiuni'); ?></div></th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        foreach($payroll as $row): ?>
            <tr>
                ...
                <td>
                    ...
                    <div>
                        <table style="width: 100%;">
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('salariu_de_baza'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                                <td style="text-align: right;"><?php echo $row['joining_salary']; ?></td>
                            </tr>
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('alocati_totale'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                                <td style="text-align: right;"><?php echo $total_allowance; ?></td>
                            </tr>
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('deducere_totala'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                            ...
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('salariu_net'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                ...
                <td>
                    <?php
                    if($row['status'] == 1)
                        echo '<div class="label label-success">' . get_phrase('platit').'</div>';
                    else
                        echo '<div class="label label-danger">' . get_phrase('neplatit').'</div>';
                    ?>
                </td>
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/payroll_details/'.$row['payroll_id']); ?>');">
                                    <i class="fa fa-eye"></i>&nbsp;
                                    <?php echo get_phrase('vezi_detali_salarizare'); ?>
                                </a>
                            </li>
                            ...
                            <?php if($row['status'] == 0) { ?>
                                <li>
                                    <a href="<?php echo site_url('admin/payroll_list/mark_paid/'.$row['payroll_id']); ?>">
                                        ...
                                        <?php echo get_phrase('marceaza_ca_platit'); ?>
                                    </a>
                                </li>
                            <?php } ?>
                        </ul>
