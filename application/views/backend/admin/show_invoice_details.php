    ...
    <div id="invoice_print">
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right">
                    <h4><?php echo get_phrase('nr_factura'); ?> : <?php echo $row['invoice_number']; ?></h4>
                    <h5><?php echo get_phrase('data_emiteri'); ?> : <?php echo $row['creation_timestamp']; ?></h5>
                    <h5><?php echo get_phrase('data_scadenta'); ?> : <?php echo $row['due_timestamp']; ?></h5>
        ...
        <table width="100%" border="0">    
            <tr>
                <td align="left"><h4><?php echo get_phrase('plata_catre'); ?> </h4></td>
                <td align="right"><h4><?php echo get_phrase('proiect_de_lege_pentru'); ?> </h4></td>
            </tr>
        ...
        <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <thead>
                <tr>
                    ...
                    <th width="60%"><?php echo get_phrase('intra'); ?></th>
        ...
        <table width="100%" border="0">    
            ...
            <tr>
                <td align="right" width="80%"><?php echo get_phrase('tva_percentaj'); ?> :</td>
                <td align="right"><?php echo $row['vat_percentage']; ?>% </td>
            </tr>
            <tr>
                <td align="right" width="80%"><?php echo get_phrase('ddiscont'); ?> :</td>
            ...
            <tr>
                <td align="right" width="80%"><h4><?php echo get_phrase('toal_general'); ?> :</h4></td>
                <td align="right"><h4><?php echo $currency_symbol . $grand_total; ?> </h4></td>
            </tr>
        </table>

        <!-- payment history -->
        <!--<h4><?php echo get_phrase('istoricul_platilor'); ?></h4>
        <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <thead>
                <tr>
                    <th><?php echo get_phrase('data'); ?></th>
                    <th><?php echo get_phrase('suma'); ?></th>
                    <th><?php echo get_phrase('metoda'); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php
