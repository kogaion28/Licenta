        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h3><?php echo get_phrase('adauga_progarmare'); ?></h3>
                </div>
            </div>
                ...
                <form role="form" class="form-horizontal form-groups" enctype="multipart/form-data"
                        ...
                        <div class="col-sm-7">
                            <div class="date-and-time">
                                <input type="text" name="date_timestamp" class="form-control datepicker" data-format="D, dd MM yyyy"
                                       placeholder="<?php echo get_phrase('data_progarmari');?>" required>
                                <input type="text" name="time_timestamp" class="form-control timepicker" data-template="dropdown" data-show-seconds="false" data-default-time="00:05 h" data-show-meridian="false" data-minute-step="5"  placeholder="timplul" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-7 col-sm-offset-3">
                            ...
                            <label class="control-label" for="notify"><?php echo get_phrase('notifica_pacientul_cu_') . 'SMS'; ?></label>
                        </div>
                    </div>
