        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h3><?php echo get_phrase('adauga_raport'); ?></h3>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select name="type" class="form-control select2" required>
                                <option value=""><?php echo get_phrase('selecteaza_tip'); ?></option>
                                <option value="operation"><?php echo get_phrase('operatiuni'); ?></option>
                                <option value="birth"><?php echo get_phrase('nasteri'); ?></option>
