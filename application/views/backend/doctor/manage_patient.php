<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_patient');?>');"
    class="btn btn-primary pull-right">
        <i class="fa fa-plus"></i> &nbsp;<?php echo get_phrase('adauga_pacient'); ?>
</button>
...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('data_nasteri');?></th>
            <th><?php echo get_phrase('varsta');?></th>
            <th><?php echo get_phrase('grupa_de_sange');?></th>
            <th><?php echo get_phrase('raport_patologi');?></th>
