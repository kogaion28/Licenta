    ...
    <div class="sidebar-user-info">
        ...
        <div class="sui-normal">
            <a href="#" class="user-link">
                ...
                <span><?php echo get_phrase('slautare'); ?>,</span>
                <strong><?php
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'manage_prescription' && $menu_check == 'from_prescription') echo 'active'; ?> ">
            <a href="<?php echo site_url('doctor/prescription');?>">
                ...
                <span><?php echo get_phrase('retete_medicale'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'manage_patient' ||
            ($page_name == 'manage_prescription' && $menu_check == 'from_patient')) echo 'active'; ?> ">
                <a href="<?php echo site_url('doctor/patient');?>">
                    ...
                    <span><?php echo get_phrase('pacienti'); ?></span>
                </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'show_blood_bank') echo 'active'; ?> ">
            <a href="<?php echo site_url('doctor/blood_bank');?>">
                ...
                <span><?php echo get_phrase('banka_de_sange'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'manage_report') echo 'active'; ?> ">
            <a href="<?php echo site_url('doctor/report');?>">
                ...
                <span><?php echo get_phrase('raport'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'payroll_list') echo 'active'; ?> ">
            <a href="<?php echo site_url('doctor/payroll_list');?>">
                <span><i class="fa fa-money"></i> <?php echo get_phrase('stat_de_plata'); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'message') echo 'active'; ?> ">
            <a href="<?php echo site_url('doctor/message');?>">
                ...
                <span><?php echo get_phrase('mesaje'); ?></span>
            </a>
        </li>
