            ...
            <div class="row">
                ...
                <div style="padding: 10px;">
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php if ($row['address'] != ''): ?>
                            <tr>
                                <td><?php echo get_phrase('adresa');?></td>
                        ...
                        <?php if ($row['phone'] != ''): ?>
                            <tr>
                                <td><?php echo get_phrase('telefon');?></td>
                        ...
                        <?php if ($row['birth_date'] != ''): ?>
                            <tr>
                                <td><?php echo get_phrase('data_nasteri');?></td>
                        ...
                        <?php if ($row['age'] != ''): ?>
                            <tr>
                                <td><?php echo get_phrase('varsta');?></td>
                        ...
                        <?php if ($row['blood_group'] != ''): ?>
                            <tr>
                                <td><?php echo get_phrase('grupa_de_sange');?></td>
