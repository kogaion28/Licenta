    ...
    <div id="payroll_print">
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right">
                    <h4><?php echo get_phrase('cod_salariu'); ?> : <?php echo $row['payroll_code']; ?></h4>
        ...
        <?php if($row['allowances'] == '') { ?>
            <div class="alert alert-info"><?php echo get_phrase('nu_alocati');?></div>
        <?php } else { ?>
        ...
        <br>
        <h4 style="text-align: center;"><?php echo get_phrase('total_deduceri'); ?></h4>
        <?php if ($row['deductions'] == '') { ?>
            <div class="alert alert-info"><?php echo get_phrase('nu_deduceri'); ?></div>
        <?php } else { ?>
            <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
                <thead>
                    <tr>
        ...
        <br>
        <h3 style="text-align: center; margin-bottom: 0px;"><?php echo get_phrase('total_salariu'); ?></h3>
