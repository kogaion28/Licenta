                ...
                <td>
                    ...
                    <div>
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('total_alocatie'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                                <td style="text-align: right;"><?php echo $total_allowance; ?></td>
                            </tr>
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('total_deducere'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/payroll_details/'.$row['payroll_id']); ?>');">
                                    <i class="fa fa-eye"></i>
                                    <?php echo get_phrase('vezi_detalile_salarizari'); ?>
                                </a>
                            </li>
                        </ul>
                    </div>
