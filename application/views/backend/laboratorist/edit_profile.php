            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('edit_profil'); ?></h3>
                    </div>
                </div>
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('laboratorist/manage_profile/update'); ?>" 
                        ...
                        <div class="col-sm-3 control-label col-sm-offset-1">
                            <button type="submit" class="btn btn-success">
                                ...
                                <?php echo get_phrase('actualizata');?>
                            </button>
                        </div>
                    </form>
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('laboratorist/manage_profile/change_password'); ?>" 
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('confirmam_noua_parola'); ?></label>
