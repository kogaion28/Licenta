...
foreach ($edit_data as $row):
    ...
    <div id="payroll_print">
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right">
                    <h4><?php echo get_phrase('cod_salar'); ?> : <?php echo $row['payroll_code']; ?></h4>
                    <h5><?php echo get_phrase('angajat'); ?> : <?php echo $user->name; ?></h5>
                    <h5><?php echo get_phrase('tipul_contului'); ?> : <?php echo get_phrase($row['user_type']); ?></h5>
        ...
        <?php if($row['allowances'] == '') { ?>
            <div class="alert alert-info"><?php echo get_phrase('fără alocații');?></div>
        <?php } else { ?>
        ...
        <br>
        <h4 style="text-align: center;"><?php echo get_phrase('rezumatul_deducerii'); ?></h4>
        <?php if ($row['deductions'] == '') { ?>
            <div class="alert alert-info"><?php echo get_phrase('fără deduceri'); ?></div>
        <?php } else { ?>
            <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
                <thead>
                    <tr>
        ...
        <br>
        <h3 style="text-align: center; margin-bottom: 0px;"><?php echo get_phrase('salariu_rezumat'); ?></h3>
        <center><hr style="margin: 5px 0px 5px 0px; width: 50%;"></center>
        <center>
            <table>
                <tr>
                    <td style="font-weight: 600; font-size: 15px; color: #000;">
                        <?php echo get_phrase('salariu_de_bazay'); ?></td>
                ...
                <tr>
                    <td style="font-weight: 600; font-size: 15px; color: #000;">
                        <?php echo get_phrase('alocația_totală'); ?></td>
                    <td style="font-weight: 600; font-size: 15px; color: #000;
                ...
                <tr>
                    <td style="font-weight: 600; font-size: 15px; color: #000;">
                        <?php echo get_phrase('deducerea_totală'); ?></td>
                    <td style="font-weight: 600; font-size: 15px; color: #000;
                        width: 15%; text-align: center;"> : </td>
                    <td style="font-weight: 600; font-size: 15px; color: #000;
    ...
    <a onClick="PrintElem('#payroll_print')" class="btn btn-primary hidden-print">
        ...
        <?php echo get_phrase('detalii_despre_salarizare'); ?>
    </a>
