...
<head>
    ...
    <meta name="description" content="MedicSOft" />
                ...
                <div class="row no-gutters justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 white-bg">
                        <div class="login-fancy pb-40 clearfix" id = "login_area">
                            <h3 class="mb-30"><?php echo get_phrase('logare'); ?></h3>
                            <form class="" action="<?php echo site_url('login/do_login');?>" method="post">
                                ...
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="Password"><?php echo get_phrase('parola'); ?>* </label>
                                    <input id="Password" class="Password form-control" type="password" placeholder="<?php echo get_phrase('parola'); ?>" name="password" required>
                                </div>
                                <button type="submit" class="btn btn-success"><?php echo get_phrase('logare'); ?></button>
                            </form>

                            <div class="section-field">
                                <div class="remember-checkbox mb-30">
                                    <a href="#" class="float-right" id = "forgot_password_button" onclick="toggleView(this)" style="color: black;"><?php echo get_phrase('paola_uitată'); ?>?</a>

                                    <!-- <a href="<?php echo base_url();?>" class="float-left" style="color: black;">
                                        <i class="entypo-left-open"></i><?php echo get_phrase('inapoi_la_website'); ?></a> -->
                                </div>
                            </div>
                        </div>

                        <div class="login-fancy pb-40 clearfix" id = "forgot_password_area" style="display: none;">
                            <h3 class="mb-30"><?php echo get_phrase('parola_uitată'); ?></h3>
                            <form class="" action="<?php echo site_url('login/reset_password'); ?>" method="post">
                                ...
                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('trimite_email'); ?></button>
                            </form>

                            <div class="section-field">
                                <div class="remember-checkbox mb-30">
                                    <a href="#" class="float-right" id = "login_button" onclick="toggleView(this)" style="color: black;"><?php echo get_phrase('inapoi_la_logare'); ?>?</a>
                                </div>
                            </div>
                        </div>
                    </div>
