        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h3><?php echo get_phrase('adaugat_donatori_de_snage'); ?></h3>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('nurse/blood_donor/create'); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select name="sex" class="form-control">
                                ...
                                <option value="female"><?php echo get_phrase('feeminin'); ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('ultima_donatie'); ?></label>
