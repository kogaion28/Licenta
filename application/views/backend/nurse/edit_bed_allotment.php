            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('editati_alocarea_paturilor'); ?></h3>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('nurse/bed_allotment/update/'.$row['bed_allotment_id']); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select name="bed_id" class="form-control select2" required>
                                    <option value=""><?php echo get_phrase('selecteaza_nr_paturilor'); ?></option>
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('descarcare_timp'); ?></label>
                        ...
                        <div class="col-sm-3 control-label col-sm-offset-2">
                            <button type="submit" class="btn btn-success">
                                <i class="fa fa-check"></i> <?php echo get_phrase('actualizati');?>
                            </button>
                        </div>
                    </form>
