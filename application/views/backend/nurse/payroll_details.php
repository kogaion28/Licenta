...
foreach ($edit_data as $row):
    ...
    <div id="payroll_print">
        ...
        <hr><br>
        <h4 style="text-align: center;"><?php echo get_phrase('Rezumatul_Salocațiilor'); ?></h4>
        ...
        <center>
            <table>
                ...
                <tr>
                    <td style="font-weight: 600; font-size: 15px; color: #000;">
                        <?php echo get_phrase('alocația_total'); ?></td>
                    <td style="font-weight: 600; font-size: 15px; color: #000;
    ...
    <a onClick="PrintElem('#payroll_print')" class="btn btn-primary hidden-print">
        <i class="fa fa-print"></i> &nbsp; <?php echo get_phrase('tipăriți_detaliile_salarizării'); ?>
    </a>
