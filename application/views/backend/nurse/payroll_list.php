            ...
            <tr>
                ...
                <td>
                    ...
                    <div>
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('alocația_total'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                                <td style="text-align: right;"><?php echo $total_allowance; ?></td>
                            </tr>
                            <tr>
                                <td style="text-align: right;"><?php echo get_phrase('total_deductie'); ?></td>
                                <td style="width: 15%; text-align: right;"> : </td>
                ...
                <td>
                    ...
                    if($row['status'] == 1)
                        ...
                        echo '<div class="label label-danger">' . get_phrase('neplatitit').'</div>';
                    ?>
                </td>
                <td>
                    <div class="btn-group">
