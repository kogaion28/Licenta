...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('categori_medicamnte'); ?></th>
            <th><?php echo get_phrase('descriere'); ?></th>
            <th><?php echo get_phrase('pret'); ?></th>
            <th><?php echo get_phrase('cantitatea_totala'); ?></th>
            <th><?php echo get_phrase('cantitate_vândută'); ?></th>
            <th><?php echo get_phrase('compania_producatorae'); ?></th>
