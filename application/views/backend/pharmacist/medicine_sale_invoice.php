...
?>
    <div id="invoice_print">
        ...
        <table width="100%" border="0">    
            <tr>
                ...
                <td align="right"><h4><?php echo get_phrase('bill_catre'); ?> </h4></td>
            </tr>
        ...
        <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <thead>
                <tr>
                    ...
                    <th width="60%"><?php echo get_phrase('nume_medicamente'); ?></th>
                    <th><?php echo get_phrase('calitate'); ?></th>
                    <th><?php echo get_phrase('pret'); ?></th>
                </tr>
            </thead>
        ...
        <table width="100%" border="0">
            <tr>
                <td align="right" width="90%"><h4><?php echo get_phrase('pret_total'); ?> :</h4></td>
    ...
    <a onClick="PrintElem('#invoice_print')" class="btn btn-primary hidden-print">
        ...
        <?php echo get_phrase('imprimare_factură');?>
    </a>
    <br><br>
