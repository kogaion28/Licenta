...
foreach ($edit_data as $row):
    ...
    <div id="payroll_print">
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right">
                    ...
                    <h5><?php echo get_phrase('Tip_de_cont'); ?> : <?php echo get_phrase($row['user_type']); ?></h5>
        ...
        <br>
        <h4 style="text-align: center;"><?php echo get_phrase('rezumatul deducerii'); ?></h4>
        <?php if ($row['deductions'] == '') { ?>
            <div class="alert alert-info"><?php echo get_phrase('fara_deduceir'); ?></div>
        <?php } else { ?>
            <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
                <thead>
                    <tr>
