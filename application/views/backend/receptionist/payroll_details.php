...
foreach ($edit_data as $row):
    ...
    <div id="payroll_print">
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right">
                    <h4><?php echo get_phrase('codul_de_salarizare'); ?> : <?php echo $row['payroll_code']; ?></h4>
                    <h5><?php echo get_phrase('angajat'); ?> : <?php echo $user->name; ?></h5>
                    <h5><?php echo get_phrase('tiplu_contului'); ?> : <?php echo get_phrase($row['user_type']); ?></h5>
        ...
        <hr><br>
        <h4 style="text-align: center;"><?php echo get_phrase('Rezumatul_alocațiilor'); ?></h4>
        <?php if($row['allowances'] == '') { ?>
            <div class="alert alert-info"><?php echo get_phrase('fara_allocati');?></div>
        <?php } else { ?>
        ...
        <br>
        <h4 style="text-align: center;"><?php echo get_phrase('rezumat_deducte'); ?></h4>
        <?php if ($row['deductions'] == '') { ?>
            <div class="alert alert-info"><?php echo get_phrase('fara_deductie'); ?></div>
        <?php } else { ?>
            <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
                <thead>
                    <tr>
        ...
        <br>
        <h3 style="text-align: center; margin-bottom: 0px;"><?php echo get_phrase('rezumat_de_salarizare'); ?></h3>
        <center><hr style="margin: 5px 0px 5px 0px; width: 50%;"></center>
        <center>
            <table>
                <tr>
                    <td style="font-weight: 600; font-size: 15px; color: #000;">
                        <?php echo get_phrase('salariu_de_baza'); ?></td>
                ...
                <tr>
                    <td style="font-weight: 600; font-size: 15px; color: #000;">
                        <?php echo get_phrase('alocație totală'); ?></td>
                    <td style="font-weight: 600; font-size: 15px; color: #000;
                ...
                <tr>
                    <td style="font-weight: 600; font-size: 15px; color: #000;">
                        <?php echo get_phrase('total_deductie'); ?></td>
                    <td style="font-weight: 600; font-size: 15px; color: #000;
                        width: 15%; text-align: center;"> : </td>
                    <td style="font-weight: 600; font-size: 15px; color: #000;
    ...
    <a onClick="PrintElem('#payroll_print')" class="btn btn-primary hidden-print">
        ...
        <?php echo get_phrase('tipăriți_detaliile_salarizării'); ?>
    </a>
