<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_appointment');?>');" 
    class="btn btn-primary pull-right">
        <i class="fa fa-plus"></i> &nbsp;<?php echo get_phrase('adauga_programare'); ?>
</button>
...
<center>
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="table">
        <tr>
            <td width="25%"><?php echo get_phrase('selecteaza_doctor'); ?></td>
            <td><?php echo get_phrase('start_data'); ?></td>
            <td><?php echo get_phrase('sfarsit_data'); ?></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="submit" value="<?php echo get_phrase('filtreaza_programarile'); ?>" class="btn btn-info" />
            </td>
        </tr>
    </table>
    </form>
